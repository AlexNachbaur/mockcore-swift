...
///
/// MockCore derives every generated field value from a seed computed from the server seed, the
...
public struct RandomSource: RandomNumberGenerator, Sendable {
    ...
    public static func stableSeed(serverSeed: UInt64, typeName: String, recordID: String?, fieldName: String)
        -> UInt64
    {
